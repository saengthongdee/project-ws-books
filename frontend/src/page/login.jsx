    ...
    <div>
      <div className='w-screen h-screen flex justify-center items-center'>
        <div className='w-100 h-[90%]'>
          ...
          <h2 className='h-10 flex justify-center text-lg items-center text-black/30 font-semibold'>Single Sign On (SSO)</h2>

          {error && (
            <div className='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg mx-auto max-w-md mb-4 text-center'>
              {error}
            </div>
          )}
