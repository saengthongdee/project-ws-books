  ...
  return (
    <header className="bg-gradient-to-b from-[#41826e] to-[#2e5f50] p-5 shadow-xl sticky top-0 z-50">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-white flex items-center gap-2 uppercase">
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-2xl overflow-hidden">
              ...
              <div className="p-4 bg-gray-50">
                ...
                <div className="space-y-2">
                  <button className="w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-gray-100 rounded-lg transition text-blue-600">
